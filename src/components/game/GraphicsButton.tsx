...
export function GraphicsButton() {
  ...
  return (
    <div ref={rootRef} className="pointer-events-auto relative">
      ...
      {open ? (
        <div className="absolute bottom-full right-0 mb-2 w-52 overflow-hidden rounded-xl border border-white/20 bg-slate-900/90 p-1 text-xs text-slate-50 shadow-lg backdrop-blur">
